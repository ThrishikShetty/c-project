...
void password(){
	...
	printf("Enter your password. press ENTER to confirm. \n");
	printf("Password:");
...
void menu(){
    ...
    printf("> Enter the number & press ENTER: ");
    scanf("%d",&number);
...
void endScreen(){
    ...
    printf("----------------------------------------------\n\n");
	printf("	>>>Group No: CP022\n");
    printf("	>>>TEAM MEMBERS\n");
    printf("	  MAKARANDA GORE \n");
    printf("	  SUDEEP\n");
    printf("	  K KARTHIK PAI\n");
    printf("   	  THRISHIK SHETTY\n");
    printf("	  KEERTHAN MARATHE\n");
...
label1:
    ...
    FILE *uR = fopen("user_Records.txt", "a+");
...
void modifyUser(){
    ...
    uR = fopen("user_Records.txt", "a");
    pT = fopen("temporary.txt", "r");

    while(fscanf(pT, "%s %s %s %lf %lf \n", fname, lname, gender, &sid, &phone) != EOF)
    {
        fprintf(uR, "%s %s %s %.0lf %.0lf \n", fname, lname, gender, sid, phone);
    }
...
label3:
    ...
    FILE *uR = fopen("book_Records.txt", "ab+");
...
int modifyBook(int rentModifier){
    ...
    FILE *uR = fopen("book_Records.txt", "r");
    FILE *pT = fopen("temporary.txt", "a");
...
label6: 
    ...
    if(nameFound == 5 && bookFound == 5)
    {
        ...
        FILE *uR = fopen("rent_Records.txt", "ab+");
...
void rentList(){
    ...
    FILE *uR = fopen("rent_Records.txt", "r");
